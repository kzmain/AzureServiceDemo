...
public class HomeController : Controller
{
    ...
    public IActionResult Service3_Demo()
    {
        var channel = _channelFactory.GetChannel(_grpc3Host);
        var client = new Serv3Demo.Serv3DemoClient(channel);
        client.Demo(new Serv3Request { });
        return View();
    }

    public IActionResult Service3_500()
    {
        var channel = _channelFactory.GetChannel(_grpc3Host);
        var client = new Serv3Demo.Serv3DemoClient(channel);
        client.Return500(new Serv3Request { });
        return View();
    }

    public IActionResult Service3_503()
    {
        var channel = _channelFactory.GetChannel(_grpc3Host);
        var client = new Serv3Demo.Serv3DemoClient(channel);
        client.Return503(new Serv3Request { });
        return View();
    }
