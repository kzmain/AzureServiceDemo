...
builder.Services.AddSingleton<ITelemetryInitializer>(new CustomTelemetryInitializer("Grpc2"));
...
if (System.Runtime.InteropServices.RuntimeInformation.OSDescription.Contains("Darwin") && isDevelopment) {
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        options.ListenLocalhost(5252, o => o.Protocols = HttpProtocols.Http2);
    });
}
...
app.MapGrpcService<Serv2DemoService>();
app.MapGet("/",
    () =>
